...
const allData = async () => {
    ...
    allPost.forEach(post => {
        ...
        card.innerHTML = `
        <div class="flex gap-4 bg-[#F2F2FF] p-10 rounded-3xl border border-[#797DFC] shadow-xl">
                            <div>
                                <img class="rounded-2xl h-[72px] w-[72px]" src=${post.image} alt="">
                                <div class="translate-y-[-80px] translate-x-8 lg:translate-x-14 h-5 w-5 ${post.isActive ? "bg-green-600" : "bg-red-600"} rounded-full"></div>
                            </div>
                            <div class="space-y-4">
...
const loadData = async (value) => {
    ...
    allPost.forEach(post => {
        ...
        card.innerHTML = `
        <div class="flex gap-4 bg-[#F2F2FF] p-2 lg:p-10 rounded-3xl border border-[#797DFC] shadow-xl">
                            <div>
                                <img class="rounded-2xl h-[72px] w-[72px]" src=${post.image} alt="">
